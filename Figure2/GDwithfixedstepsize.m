%% Parameters 
% % Stepsize and noise
eta_BS_4=[40,40,40,40,40];
eta_BS_2=[6,6,6,6,6,0.3,0.3,0.3,0.3,0.3];
eta_BS_0=[];
...
legend('$\mathrm{GD}~\Sigma_w=10^{-4}I~ \eta=100$','$\mathrm{GD}~\Sigma_w=10^{-2}I~ \eta=1$','interpreter','latex','FontSize',9)
save("fixedPG.mat")
