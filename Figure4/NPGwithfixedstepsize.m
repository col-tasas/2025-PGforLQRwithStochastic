...
eta_BS_4=[0.05,0.05,0.05,0.05,0.05]; %step size for noise 10^-4
eta_BS_2=[0.05,0.05,0.05,0.05,0.05]; %step size for noise 10^-2
eta_BS_0=[0.05,0.05,0.05,0.05,0.05]; %step size for noise 10^-0
...
for counter=1:num_BS
    ...
    for i=1:episode
        ...
        kcurrentNBS=kcurrentNBS-0.09/(1+2*ckBS(1,counter))*nablaK*inv(SigmaK);
        catch
            break;
        end
    end
